...
router.post('/', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), category_controller_1.categoryController.insertIntiDB);
router.get('/', category_controller_1.categoryController.findAllCategory);
